package org.test.demo.base.crc16;

/**
 * CRC16算法java实现 模仿C++代码改写的Java实现
 * https://github.com/swgithub1006/mqstudy/blob/master/src/main/java/org/coffee/netty/tools/CRC16Util.java
 *
 * @author night knight http://nightknight.iteye.com/blog/317894
 * @create 2019-08-23 10:27
 */
public class CRC16Util {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(crc16Short(test));
